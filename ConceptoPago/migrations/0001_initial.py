    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_ad', models.CharField(choices=[('asignacion', 'Asignacion'), ('deduccion', 'Deduccion'), ('prestamo', 'Prestamo')], default='asignacion', max_length=30, verbose_name='Asignacion/Deduccion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='RecursosHumanos.Empleado')),
                ('elemento_pago', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ConceptoPago.ElementoPago')),
            ],
            options={
